...
function finalizeStart(){
    var that = this;
    // finalizeStart is called only after startPlaylistGenerator is successfully returned.
    // startPromise is resolved in this function.
    if (!Q.isPending(that.startPromise)) {
...
PlaylistGenerator.prototype.initialStart = function() {
    var that = this;
