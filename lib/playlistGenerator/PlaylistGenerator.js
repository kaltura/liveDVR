...
function applyHLSWindowFactor (val) {
    var calculatedWindowSizeMilliseconds = Math.min( val * hlsWindowProtectionFactor, val * (hlsWindowProtectionFactor-1) + 600000);
    return calculatedWindowSizeMilliseconds < hlsMaxAllowedWindowSizeMilliseconds ? calculatedWindowSizeMilliseconds : hlsMaxAllowedWindowSizeMilliseconds;
