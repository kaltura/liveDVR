...
const maxDVRWindowInHours = 60 * 60 * 1000 * config.get("playlistConfig").maxDVRWindowInHours;
...
function applyHLSWindowFactor (val) {
    ...
    return calculatedWindowSizeMsec < maxDVRWindowInHours ? calculatedWindowSizeMsec : maxDVRWindowInHours + extraTimeMsec;
