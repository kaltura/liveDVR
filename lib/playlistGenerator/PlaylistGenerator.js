...
function removeObsoleteChunks(flavor,removedChunks) {
    ...
    if (removedChunks.length) {
        ...
        that.emit(makeFlavorEventName.call(flavor,'plyst-clips-removed'),removedChunks)
    }
}
...
PlaylistGenerator.prototype.flvRemoveListener = function (name, fn) { = function(flavorId,event,handler) {
