...
var doPersist =  function() {
    ...
    try {
        ...
        if (false && playlistUtils.playlistConfig.debug) {
            Playlist.prototype.serializeFrom(that.playlistType, jsonStr, that.loggerInfo,function(newPlaylist){
...
function startPlaylistGenerator() {
    ...
    that.startPromise = qio.read(that.playlistPath)
        .then(function(data) {
            Playlist.prototype.serializeFrom(that.playlistType, data, that.loggerInfo, function (newPlaylist) {
                setPlayList.call(that, newPlaylist);
            })
        })
        .catch(function(err) {
