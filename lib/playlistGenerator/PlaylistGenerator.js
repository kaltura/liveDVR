...
PlaylistGenerator.getAbsoluteTimeFromRelative = function(playlist, relativeTime)
{
    ...
    if (relativeTime < 0 || totalPlaylistDuration < relativeTime)
    {
        logger.error(`Error: Relative time is bigger than duration. total=${totalPlaylistDuration},relativeTime=${relativeTime}`);
        return null;
    }
    let i = 0;
