...
module.exports = (function(){
    ...
    function lastTimestampSessionModification(lastModificationTime, isFromDisk, entryId) {
        ...
        logger.debug("Entry was last live at %s; time passed = %d sec; Grace period duration: %d seconds", lastModificationTime, (currentTime - lastModificationTime)/1000, timeToWait/1000);
