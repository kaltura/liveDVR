...
var PtsAlligner = (function(){
    ...
    function PtsAlligner(folderPath, loggerInfo){
        this.initialized = false;
        this.folderPath = folderPath;
        this.logger = loggerModule.getLogger("PtsAligner", loggerInfo);
    }
        ...
        var singleFileAlignmentPromise =
            qio.read(path.join(that.folderPath, filenameToProcess), "b") // Read binary data into a buffer
                .then(function(dataBuffer) {
                    ...
                    var chunkDuration = nativePtsAligner.rebaseTs(that.context, dataBuffer,config.get("universalTsTimestamp"));
