...
function updateStreamInfo() {
    backendClient.updateStreamInfo(this.entryId, this.entryServerNodeId, this.flavorsObjArray)
        .then(function() {
            this.logger.debug("Flavors updated in DB");
        });
}
