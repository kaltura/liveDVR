    ...
    function getMediaServerManifest() {
        ...
        return Q.allSettled(mapFlavors)
                ...
                _.each(results, function(result) {
                    if (result.state === "fulfilled") {
                        ...
                        if (result.value.indexOf("RESOLUTION") > -1) {
                            ...
                            playerPlaylist += appendManifest(playerPlaylist, result.value, true, flavors[flavorArrIndex]);
                        }
                    }
                    else {
            ...
            .then(function(manifest) {
                ...
                updateFlavorsList(playerPlaylist);
            ...
            .then(function(manifest) {
                ...
                return Q.resolve({playlistObj : manifest, playlist : playerPlaylist, flavorsList : flavors});
            })
