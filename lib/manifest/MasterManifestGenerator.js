...
var ManifestGenerator = (function() {

    function ManifestGenerator(entryObject, isNewSession, logger) {
    ...
    ManifestGenerator.prototype.updatePlaylist = function() {
        var that = this;
    ...
    ManifestGenerator.prototype.createManifest = function() {
        var that = this;
