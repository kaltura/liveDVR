...
module.exports = function(downloadedChunksGetter, outputFolderPath, filename, timeWindowSize, maxChunkCount, logger){
    ...
    logger = loggerDecorator(logger, "Two phased manifest generator: ");

    var intermediateManifestDecoratedLogger = loggerDecorator(logger, "Intermediate manifest generator: ");
    var externalizedManifestDecoratedLogger = loggerDecorator(logger, "Externalized manifest generator: ");
                ...
                return ptsAligner.process(chunksToUpdate.slice())
                    .then(function () {
                        ...
                        return {
                            ...
                            lengthNewItems : updateResult.lengthNewItems
                        };
                    });
            });
    };
