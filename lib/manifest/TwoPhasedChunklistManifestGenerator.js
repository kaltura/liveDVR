...
module.exports = function(downloadedChunksGetter, outputFolderPath, filename, timeWindowSize, maxChunkCount,  loggerInformation){
    ...
    var logger = loggerModule.getLogger("Two phased manifest generator", loggerInformation);


    var intermediateManifestDecoratedLogger = loggerModule.getLogger("Intermediate manifest generator" ,loggerInformation);
    var externalizedManifestDecoratedLogger = loggerModule.getLogger("Externalized manifest generator" ,loggerInformation);
    ...
    var ptsAligner = new PtsAlligner(outputFolderPath, logger);
