...
var EndlistAppender = function EndListAppender(){
        ...
        return Q.fcall(function () {
            ...
            var promises = _.map(flavorManifestPaths, function (flavorManifestPath) {
                return m3u8Parser.parseM3U8(flavorManifestPath)
                    ...
                    .then(function(){
                        var playlistGenerator = new PlaylistGenerator({entryId : entryId},false,logger);
                        return playlistGenerator.start()
                            .then(function() {
                                return playlistGenerator.deliverEndOfPresentation();
                            });
                    })
                    .catch(function (err) {
    ...
    var addEntry = function addEntry(entryId) {
        ...
        return Q.fcall(function(){
            ...
            var timeoutObj = setTimeout(function () {
                if( that._entriesToProcess[entryId]) {
                    that._entriesToProcess[entryId] = appendEndlistIfMissing.call(that, entryId).then(function () {
            ...
            that._entriesToProcess[entryId] = Q.resolve(timeoutObj);
    ...
    var removeEntry = function removeEntry(entryId) {
        ...
        return Q.fcall(function(){
            ...
            if (timeoutObj) {
                timeoutObj.then(function(timeoutObj) {
                    if(timeoutObj) {
