...
var MP4WriteStream = (function(){
    function MP4WriteStream(chunkPath, loggerInfo) {
        ...
        that.savedChunk = config.get('preserveOriginalHLS') ? fs.createWriteStream(chunkPath) : undefined;
...
var onEnd = function (fileInfo) {
    ...
    that.logger.trace("onEnd ", util.inspect(fileInfo));
...
var onFinish = function() {
    ...
    try {
        that.logger.trace("onFinish. Attempt to open file ");
