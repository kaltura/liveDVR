    ...
    function MP4WriteStream(chunkPath, logger) {
        ...
        var onFinish = function() {
            ...
            try {
                ...
                var convertedPath,extIdx = chunkPath.lastIndexOf('.');
                if( extIdx > 0 ) {
                    convertedPath = chunkPath.substring(0,extIdx);
                } else {
                    convertedPath = chunkPath;
                }
                convertedPath += '.mp4';
                ws = fs.createWriteStream(convertedPath);
