...
module.exports = function(entryId, hostname, port, applicationName, logger) {
    ...
    var getAllFlavors = function getAllFlavors(manifestGenerator)
    {
        ...
        //var repetitivePromise = promUtils().retryPromise(newBehaviour().getMediaServerManifest, 3000, 10, "Could not get manifest");
