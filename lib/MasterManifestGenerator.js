...
module.exports = function(entryId, hostname, port, applicationName, destPath) {

    var persistenceFormat = require('./PersistenceFormat')(destPath);
    ...
    var getMediaServerManifest = function(smil){
        return Q.fcall(function(){
            ...
            return qHttp.read(mediaServerUrl);
