...
var EntryDownloader = (function () {
    ...
    function EntryDownloader(entryId, hostname, port, applicationName, flavorsIds, manifestTimeWindow, manifestMaxChunkCount) {
        ...
        this.smilManifestObj = smilBasedManifest(entryId, hostname, port, applicationName, logger);
        this.flavorsManifestObj = flavorsBasedManifest(entryId, hostname, port, applicationName, flavorsIds, logger);
    }
    ...
    EntryDownloader.prototype.start = function () {
        ...
        return that.masterManifestGenerator.getAllFlavors(that.flavorsManifestObj)
