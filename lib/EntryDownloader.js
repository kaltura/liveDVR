...
var EntryDownloader = (function () {
    ...
    function EntryDownloader(entryId, hostname, port, applicationName, dvrWindow, maxChunkCount) {
            ...
            .then(function(flavors) {
                that.flavorsDownloaders = _.chain(flavors)
                    ...
                    .map(function (flavor) {
                        ...
                        return new flavorDownloader(flavor.liveURL, destPath, that.entryId, bitrate, playlistName, that.dvrWindow, that.maxChunkCount);
                    }).value();
