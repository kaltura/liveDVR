...
var EntryDownloader = (function () {
    ...
    function EntryDownloader(entryId, hostname, port, applicationName, flavorsIds, manifestTimeWindow, manifestMaxChunkCount) {
        ...
        this.masterManifestGenerator = masterManifestGeneratorCreator(entryId, hostname, port, applicationName, flavorsIds, logger);
    }
    ...
    EntryDownloader.prototype.start = function () {
        ...
        // TODO: Figure out how to transfer the boolean parameter to getAllFlavors
        return that.masterManifestGenerator.getAllFlavors(true)
