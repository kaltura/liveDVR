    ...
    EntryDownloader.prototype.start = function () {
        ...
        return that.masterManifestGenerator.getAllFlavors()
            .then(function (flavors) {
                var distinctFlavors = _.uniq(flavors, function(flavor){
                    return flavor.bandwidth;
                })

                var flavorBitrates = _.pluck(distinctFlavors, 'bandwidth');
                return storageClient.addEntryIfAbsent(that.entryId, flavorBitrates).then(function(){
