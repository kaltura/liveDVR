 ...
 * @action getLast.
 */
function KalturaBeacon(client){
    KalturaBeacon.super_.call(this);
    this.init(client);
}

util.inherits(KalturaBeacon, kaltura.KalturaServiceBase);
 ...
 * @return bool
 */
KalturaBeacon.prototype.add = function(callback, beacon, shouldLog = 0, ttl = 600) {
    let kparams = {};
    this.client.addParam(kparams, 'beacon', kaltura.toParams(beacon));
    this.client.addParam(kparams, 'shouldLog', shouldLog);
    this.client.addParam(kparams, 'ttl', ttl);
 ...
 */
KalturaBeacon.prototype.enhanceSearch = function(callback, filter = null, pager = null) {
	let kparams = {};
    if (filter !== null){
...
KalturaBeacon.prototype.enhanceSearch = function(callback, filter = null, pager = null) {
    ...
    this.client.queueServiceActionCall('beacon_beacon', 'getLast', kparams);
    if (!this.client.isMultiRequest()){
        this.client.doQueue(callback);
    }
};
...
/**
 *Class definition for the Kaltura service: captureSpace.
 * The available service actions:
 * @action clientUpdates Returns latest version and URL.
 */
function KalturaCaptureSpaceService(client){
	KalturaCaptureSpaceService.super_.call(this);
	this.init(client);
}

util.inherits(KalturaCaptureSpaceService, kaltura.KalturaServiceBase);
module.exports.KalturaCaptureSpaceService = KalturaCaptureSpaceService;
 ...
 */
KalturaCaptureSpaceService.prototype.clientUpdates = function(callback, os, version){
	var kparams = {};
	this.client.addParam(kparams, 'os', os);
	this.client.addParam(kparams, 'version', version);
	this.client.queueServiceActionCall('capturespace_capturespace', 'clientUpdates', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
...
KalturaEventNotificationTemplateService.prototype.register = function(callback, notificationTemplateSystemName, pushNotificationParams){
	...
	this.client.addParam(kparams, "pushNotificationParams", kaltura.toParams(pushNotificationParams));
