 ...
 * The available service actions:
 * @action delete Deletes the row in the database.
 * @action update .
 * @action list .
 * @action get .
 */
 ...
 * @return .
 */
KalturaEntryServerNodeService.prototype.delete = function(callback, id){
	var kparams = {};
	this.client.addParam(kparams, 'id', id);
	this.client.queueServiceActionCall('entryservernode', 'delete', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
