 ...
 * @param LiveEntryStatus int determine broadcasting / playing/ stopped (optional, enum: KalturaLiveEntryStatus).
 * @return KalturaLiveEntry.
 */
KalturaLiveChannelService.prototype.registerMediaServer = function(callback, entryId, hostname, mediaServerIndex, applicationName, status){
	if(!applicationName){
 ...
 * @return KalturaLiveEntry.
 */
KalturaLiveStreamService.prototype.registerMediaServer = function(callback, entryId, hostname, mediaServerIndex, applicationName, status){
	if(!applicationName){
		applicationName = null;
	}
	var kparams = {};
	...
	this.client.addParam(kparams, 'liveEntryStatus', status);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
