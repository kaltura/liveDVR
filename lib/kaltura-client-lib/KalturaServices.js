...
/**
 *Class definition for the Kaltura service: beaconService.
...
function KalturaBeaconService(client){
    KalturaBeaconService.super_.call(this);
    this.init(client);
}

util.inherits(KalturaBeaconService, kaltura.KalturaServiceBase);
module.exports.KalturaBeaconService = KalturaBeaconService;
 ...
 * @return bool
 */
KalturaBeaconService.prototype.add = function(callback, beacon, shouldLog = 0, ttl = 600){
    let kparams = {};
 ...
 */
KalturaBeaconService.prototype.enhanceSearch = function(callback, filter = null, pager = null) {
	let kparams = {};
    if (filter !== null){
