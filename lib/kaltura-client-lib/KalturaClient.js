 ...
 * @param kaltura.services.KalturaBeaconService
 */
KalturaClient.prototype.beaconService = null;
/**
...
/**
 * 
 * @param kaltura.services.KalturaCaptureSpaceService
 */
KalturaClient.prototype.captureSpace = null;
/**
...
KalturaClient.prototype.init = function(config){
	...
	this.beaconService = new kaltura.services.KalturaBeaconService(this);
	...
	this.captureSpace = new kaltura.services.KalturaCaptureSpaceService(this);
