...
function KalturaTaskEntryServerNode(){
	KalturaTaskEntryServerNode.super_.call(this);
}
module.exports.KalturaTaskEntryServerNode = KalturaTaskEntryServerNode;

util.inherits(KalturaTaskEntryServerNode, KalturaEntryServerNode);
...
function KalturaClippingTaskEntryServerNode(){
	KalturaClippingTaskEntryServerNode.super_.call(this);
	this.clipAttributes = null;
	this.clippedEntryId = null;
}
module.exports.KalturaClippingTaskEntryServerNode = KalturaClippingTaskEntryServerNode;

util.inherits(KalturaClippingTaskEntryServerNode, KalturaTaskEntryServerNode);
