...
module.exports = function(chunksData, contentFolder, currentManifest){

    var firstChunkDownloadTime = chunksData[currentManifest.items.PlaylistItem[0].get('uri')].downloadTime;

    var resTemplate = {
        "playlistType": "live",
        "discontinuity": false,
        "segmentBaseTime": 0,
        "firstClipTime": firstChunkDownloadTime * 1000,
        "durations": [],
        "sequences": [
            {
                "clips": [
