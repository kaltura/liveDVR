...
var BackendClient = (function(){
    ...
    // Minutes in 30 days = (# of days) * (# of hours in a day) * (# of minutes in an hour)
    const beaconTtlDurationInMs = convertToMs(config.get('diagnostics').beaconsTtlDurationInDays * 24 * 60);
    let client = null;
    ...
    function sendBeacon(entryId, clientPartnerId, data, beaconTag) {
        ...
        }, KalturaBeacon, kalturaTypes.KalturaNullableBoolean.TRUE_VALUE, beaconTtlDurationInMs);
