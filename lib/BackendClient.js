...
var BackendClient = (function(){
    ...
    function getParams(item){
      var res = {
          ...
          "flavorParamsIds" : item.flavorParamsIds,
            // TODO: Retreive ServerIndex - Figure out to which DC we're streaming! -> Gad
        };
    ...
    BackendClient.registerEntryInDatabase = function(entryObject, state) {
        ...
        return createSession()
            .then(function() {
                return registerEntryInDatabase(entryObject.entryId, entryObject.serverIndex, state);
            });
    };
    ...
    // TODO: Do we need to create session after each API request? -> Gad
