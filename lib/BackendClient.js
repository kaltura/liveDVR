...
var BackendClient = (function(){
    ...
    function getServerType(serverNodeId, resultReceived) {
        ...
        if (resultReceived.primaryServerNodeId === serverNodeId) {
            return (serverNodeId === 0) ? kalturaTypes.KalturaEntryServerNodeType.LIVE_PRIMARY :
                kalturaTypes.KalturaEntryServerNodeType.LIVE_BACKUP;
        }
        else {
            return (serverNodeId === 0) ? kalturaTypes.KalturaEntryServerNodeType.LIVE_BACKUP:
                kalturaTypes.KalturaEntryServerNodeType.LIVE_PRIMARY;
        }
    }
