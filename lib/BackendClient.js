...
var BackendClient = (function(){
    ...
    function registerEntryInDatabase(entryObject, streamState, event) {
        var deferred = Q.defer();
        // recoreded entry Id is created by liveStream.createRecordedEntry(), this flag is for backward compatibility
    ...
    BackendClient.getSingleEntryServerNode = function(entryId, entryServerType) {
        let filter = new kalturaVO.KalturaEntryServerNodeFilter();
        filter.serverTypeEqual = entryServerType;
        return getLiveEntryServerNodes(entryId, filter)
