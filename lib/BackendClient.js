...
var BackendClient = (function(){
    ...
    function registerEntryInDatabase(entryObject, state, event) {
        var deferred = Q.defer();
        logger.debug(`[${entryObject.entryId}] Calling registerMediaServer. Hostname: [${mediaServerHostname}], serverIndex: [${entryObject.serverType}], Application: [${applicationName}], state: [${state}]`);
