...
var BackendClient = (function(){
    ...
    var createClientConfig = function () {
        ...
        conf.serviceUrl = config.get('serviceUrl');
        return conf;
    };
    ...
    var adminSecret = config.get('adminSecret');
    var partnerId = config.get('partnerId');
    var mediaServerHostname = config.get('mediaServerHostname');
    var client = null;
    var clientConfig = createClientConfig();
    var sessionDuration = convertToMs(config.get('backendClientSessionDurationMinutes'));
