...
// TODO: Figure out the correct parameter to the KalturaLiveChannelService constructor
//var kalturaServices = require('./kaltura-client-lib/KalturaServices').KalturaLiveChannelService();
...
var BackendClient = (function(){
    ...
    BackendClient.registerEntryInDatabase = function(entryObject, state) {
        logger.info("Calling registerMediaServer, and writing entry " + entryObject.entryId + " to database");
        // TODO: Send callback to function and figure out how to retrieve the mediaServerIndex
        //return kalturaServices.registerMediaServer(blabla, entryObject.entryId, config.get('mediaServer').hostname, blabla, config.get('mediaServer').applicationName, state);
    };
