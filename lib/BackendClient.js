...
var stringUtil = require('./utils/string-utils');
...
var BackendClient = (function(){
    ...
    function registerEntryInDatabase(entryObject, streamState, event) {
        ...
        }, entryObject.entryId, mediaServerHostname, entryObject.serverType, applicationName , streamState, false);
    ...
    function resetRecordingEntry(entryObj) {
        ...
        client.entryServerNode.listAction(null, EntryServerNodeFilter);
        client.liveStream.registerMediaServer(null, entryObj.entryId, mediaServerHostname, entryObj.serverType, applicationName, streamState, false);
    ...
    function createRecordedEntry(entryObj)  {
        ...
        client.doMultiRequest((results, err, headers)=> {
            ...
            if (iskMultiRequestSuccessful(results, err, 2)) {
                ...
                logger.info(`[${entryObj.entryId}] Successfully retrieved new recordedEntryId:[${newRecordedEntryId}], replacing [${entryObj.recordedEntryId}]`);
