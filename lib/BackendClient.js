...
var BackendClient = (function(){
    ...
    function updateIsPlayableUser(entryServerNodeId, isPlayableUser)
    {
        var deferred = Q.defer();
        let liveEntryServerNode = new kalturaVO.KalturaLiveEntryServerNode();
    ...
    BackendClient.updateIsPlayableUser = (entryServerNodeId, isPlayableUser) => {
        return createSession().
            then(() => {
               return updateIsPlayableUser(entryServerNodeId, isPlayableUser);
            });
    }
