...
var BackendClient = (function(){
    ...
    function sendBeacon(entryId, data, beaconTag) {
        ...
        KalturaBeacon.relatedObjectType = kalturaTypes.BeaconObjectTypes.ENTRY_SERVER_NODE_BEACON;
        KalturaBeacon.eventType = tag;
        KalturaBeacon.objectId = entryId;
        KalturaBeacon.privateData = data;
    ...
    BackendClient.sendBeacon = (entryId, data, beaconTag) => {
        logger.debug(`[${entryId}] Entered sendBeacon. Creating session and sending call`);
        return createSession()
            .then(()=> {
                return sendBeacon(entryId, data, beaconTag);
            });
    };
