...
var BackendClient = (function(){
    ...
    BackendClient.updateEntry = function(entryId, cumulativeDurationMs){
        logger.debug("[%s] updateEntry with %s", entryId, cumulativeDurationMs);
        return createSession()
            .then(function() {
                return updateEntry(entryId, cumulativeDurationMs);
            });
    }
