    ...
    function sendBeacon(entryId, clientPartnerId, data, beaconTag) {
        ...
        client.beacon.add((result, err, headers)=> {
            ...
            if(err || result.objectType === 'KalturaAPIException') {
                ...
                logger.info(`[${entryId}] Successfully sent Beacon [${tag}] to server`);
                deferred.resolve();
            }
