...
var BackendClient = (function(){
    ...
    function addServerNode(hostname) {
        ...
        kalturaWowzaServerNode.mediaServerPortConfig = [];
        kalturaWowzaServerNode.mediaServerPlaybackDomainConfig = [];

        let kalturaKeyValue1 = new kalturaVO.KalturaKeyValue();
        kalturaKeyValue1.key = 'http';
        kalturaKeyValue1.value = '1935';
        let kalturaKeyValue2 = new kalturaVO.KalturaKeyValue();
        kalturaKeyValue2.key = 'http-hls';
        kalturaKeyValue2.value = '8080';
        kalturaWowzaServerNode.mediaServerPortConfig.push(kalturaKeyValue1);
        kalturaWowzaServerNode.mediaServerPortConfig.push(kalturaKeyValue2);
        kalturaKeyValue1.value = hostname;
        kalturaKeyValue2.value = hostname;

        kalturaWowzaServerNode.mediaServerPlaybackDomainConfig.push(kalturaKeyValue1);
        kalturaWowzaServerNode.mediaServerPlaybackDomainConfig.push(kalturaKeyValue2);
