...
// todo Assumptions:
        ...
        return Q.resolve().then(()=> {
            ...
            function getRecordingEntrySession(entryObj) {
                ...
                return this.verifyStreamMatchPreviousFlavorSet(entryObj)
                    .then((flavorsMatch) => {
                        if (!flavorsMatch) {
                            return this.resetRecordedEntry(entryObj);
                        }
                    })
                    .then(() => {
    ...
    splitRecording(entryId) {
        ...
        if (!recordingSession.mp4FilesQueueLock) {
            ...
            return this.resetRecordedEntry(recordingSession.entryObject)
                .then(()=> {
        ...
        return backendClient.getEntryInfo(entryId)
            .then((entryObj) => {
                if (entryObj.recordedEntryId) {
                    ...
                    let newRecordingDirectory = persistenceFormat.getRecordingSessionPath(entryId, recordingEntrySession.recordedStatus, recordedEntryId);
    ...
    resetRecordedEntry(entryObject) {
    ...
    verifyStreamMatchPreviousFlavorSet(entryObj) {
        let recordingSessionPath = persistenceFormat.getRecordingSessionPath(entryObj.entryId, entryObj.recordedStatus, entryObj.recordedEntryId);
                ...
                if (!sessionExist) {
                    ...
                    return qio.listTree(recordingSessionPath,
                        ...
                        .then((flavorsDirs)=> {
                            ...
                            if (flavorsDirs.length != entryObj.flavorsObjArray.length) {
                            ...
                            let flavorsDiff = _.difference(flavorsDirs, entryObj.flavorsObjArray);
