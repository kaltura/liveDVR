...
// todo Assumptions:
    ...
    startRecording(entryObj, flavorsObjArray, playlistGenerator){
        return Q.resolve().then(()=> {
            ...
            // replace recording window max size with actual allowed size
            this.recordingMaxDurationInMs = playlistGenerator.playListLimits.manifestTimeWindowInMsec;
