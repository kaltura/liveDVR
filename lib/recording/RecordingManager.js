...
// todo Assumptions:
    ...
    replaceUnknownRecordedEntry(recordingEntrySession) {
        if (recordingEntrySession.unknownReplacementInProcess === true){
            return Q.reject(`[${recordingEntrySession.entryId}] Replacement of UNKNOWN entry is already running`);
        }
        recordingEntrySession.unknownReplacementInProcess = true;
        logger.debug(`[${recordingEntrySession.entryId}] [replaceUnknownRecordedEntry][1 of 4] About to call get entry`);
