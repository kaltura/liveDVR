...
class RecordingEntrySession {
    constructor(entryObj, mp4FilesQueue = null) {
        ...
        this.recordedStatus = entryObj.recordStatus;
        this.recordingSessionPath = persistenceFormat.getRecordingSessionPath(this.entryId, this.recordedStatus, this.recordedEntryId);
