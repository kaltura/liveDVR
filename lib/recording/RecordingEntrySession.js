...
const minTimeBeforeFirstUpdateMs = 60 * 1000;
...
class RecordingEntrySession {
    ...
    updateEntryDuration(force){
        ...
        let updateFirstTime = !this.lastUpdateDuration && duration > minTimeBeforeFirstUpdateMs;
        if (force || updateFirstTime || duration > this.lastUpdateDuration + recordingUpdateEntryTimeIntervalMs) {
