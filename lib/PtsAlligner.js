        ...
        var singleFileAlignmentPromise =
            qio.read(path.join(that.folderPath, filenameToProcess), "b") // Read binary data into a buffer
                .then(function(dataBuffer) {
                    that.logger.debug("Old PTS alignment context: " + JSON.stringify(that.context)+" for "+filenameToProcess);
                    ...
                    that.logger.debug("New PTS alignment context: " + JSON.stringify(that.context)+" for "+filenameToProcess);
