...
module.exports = function(downloadedChunksGetter, outputFolderPath, filename, dvrWindowSize, maxChunkCount, logger){
    ...
    var intermediateManifest = chunklistManifestGenerator(outputFolderPath, filename + '.intermediate', dvrWindowSize, maxChunkCount, intermediateManifestDecoratedLogger);
    var externalizedManifest = chunklistManifestGenerator(outputFolderPath, filename, dvrWindowSize, maxChunkCount, externalizedManifestDecoratedLogger);
    var ptsAligner;
