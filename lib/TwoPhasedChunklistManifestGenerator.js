...
module.exports = function(entryId, flavor, outputFolderPath, filename, dvrWindowSize, logger){
    ...
    var update = function updateChunklist(newItems) {
        return intermediateManifest.update(newItems)
            .then(function(){
                return storageClient.getEntry(entryId).then(function(entryData){
                    return entryData.downloadedChunks[flavor];
                })
            }).then(function(files) {
