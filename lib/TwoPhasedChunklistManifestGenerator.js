...
var mp4Duplicator = require('./Mp4Duplicator');
        ...
        return intermediateManifest.update(newItems)
            .then(function(updateResult){
                ...
                return ptsAligner.process(chunksToUpdate.slice())
                    .then(function(){
                        var chunkPaths = _.map(chunksToUpdate, function(c){
                            return path.join(outputFolderPath, c.get('uri'));
                        })
                        return mp4Duplicator.process(chunkPaths);
                    })
                    .then(function () {
