        ...
        const startRecording =  (entryObj, flavorId) => {
            ...
            if (!recordingList[entryId]) { // if this flavor is the first todo check that no race between flavor
               ...
               recordingList[entryId]  = {
                ...
                recordingList[entryId].playlistGenerator = playlistGenerator //todo check that its not passed the limit
                recordingList[entryId].duration = playlistGenerator.getTotalDuration()
