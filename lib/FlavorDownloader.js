...
var FlavorDownloader = (function () {
    ...
    function FlavorDownloader(m3u8Url, destPath, entryId, flavor, newPlaylistName, dvrWindow) {
        ...
        this.m3u8generator = twoPhasedChunklistManifestGenerator(downloadedChunksGetter, this.destFolderPath, newPlaylistName, dvrWindow, this.logger);
    }
        ...
        return qfs.makeTree(this.tmpM3u8Folder)
            ...
            .then(function(){
                ...
                return pGlob(path.join(that.destFolderPath, '*.ts')).then(function(downloadedChunks){
                    that.downloadedChunks = downloadedChunks;
                })
            })
            .then(function(){
