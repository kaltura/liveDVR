...
var ConfFactorySingleton = require('./ConfigurationFactory.js');
...
var FlavorDownloader = (function () {
    ...
    function FlavorDownloader(m3u8Url, destPath, entryId, flavor, newPlaylistName, manifestTimeWindow, manifestMaxChunkCount) {
        ...
        this.downloadChunk = ConfFactorySingleton.mockDownloadChunk ? ConfFactorySingleton.mockDownloadChunk
            : this.httpUtils.downloadFile;
    ...
    var downloadChunks = function (that, baseUrl, chunksToDownload) {
        return Q.allSettled(_.map(chunksToDownload, function (chunkName) {
            ...
            return that.downloadChunk(chunkUrl, path.join(that.destFolderPath, chunkName))
                .then(function(){
