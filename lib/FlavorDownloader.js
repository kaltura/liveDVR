...
var FlavorDownloader = (function () {
    ...
    var maxInitializationAttempts = 1;
        ...
        return downloadPlaylist(that)
            ...
            .catch(function failure(err) {
                ...
                if (that.failedAttempts === maxInitializationAttempts) {
                    ...
                    that.logger.error("Flavor downloader failed " + maxInitializationAttempts + " consecutive times - stopping it");
                    return that.stop().catch(function(err){
