...
var preserveOriginalHLS = config.get('preserveOriginalHLS');
var configManipulator;
if (preserveOriginalHLS && preserveOriginalHLS.enable || regressionAdapterConfig && regressionAdapterConfig.enable) {
    configManinpulator = require('./RegressionAdapter/RegressionConfig.js').RegressionConfig.instance;
}
