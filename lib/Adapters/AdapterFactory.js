    ...
    if (!adapter) {
        if (regressionAdapterConfig && regressionAdapterConfig.enable) {
            ...
            if (_.isArray(mediaServerConfig.hostname)) {
                ...
                let wowzaHost = mediaServerConfig.wowzaHost ? mediaServerConfig.wowzaHost: mediaServerConfig.hostname;
                let metadataHostName = mediaServerConfig.wowzaMetadataHost ? mediaServerConfig.wowzaMetadataHost: wowzaHost;
                adapter = new WowzaAdapter(mediaServerConfig, wowzaHost, metadataHostName);
            }
        }
    }
