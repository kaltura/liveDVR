...
RegressionConfig.prototype.initChunklistEdgeIndexes = function (entry_index) {
    ...
    let chunklist_indexes_not_initialized = (isNaN(entryConfig.start_chunklist_index)  || (entryConfig.start_chunklist_index === -1)
                                            || isNaN(entryConfig.last_chunklist_index) || (entryConfig.last_chunklist_index === -1));
