...
TestHelper.prototype.initEntries = function() {
    ...
    qio.removeTree(fullpath)
        ...
        .then(function () {
            that.validators[entryConfig.entryId] = new validator(entryConfig.entryId, that.entries[entryConfig.entryId].flavors, that.entries[entryConfig.entryId].last_chunklist_index, entryConfig.validator);
        })
        .then(function() {
