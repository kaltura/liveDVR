...
const master_playlist_all =
    '#EXT-X-VERSION:3 \
    #EXT-X-STREAM-INF:BANDWIDTH=3273341,RESOLUTION=1280x720 \
    32/chunklist.m3u8 \
    #EXT-X-STREAM-INF:BANDWIDTH=1094569,RESOLUTION=480x270 \
    33/chunklist.m3u8 \
    #EXT-X-STREAM-INF:BANDWIDTH=1447205,RESOLUTION=640x360 \
    34/chunklist.m3u8 \
    #EXT-X-STREAM-INF:BANDWIDTH=2205365,RESOLUTION=640x360 \
    35/chunklist.m3u8';
    ...
    try {
        ...
        // playlist
            ...
            if (params.filename.indexOf('playlist_w111.m3u8') > -1) {
                weblogger.debug('>>>>> TEMP <<<<< THE PLAYLIST %s', params.filename);
            }
