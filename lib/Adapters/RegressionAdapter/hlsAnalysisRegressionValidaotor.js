...
class HlsAnalysisRegressionValidator extends HlsChecksumRegressionValidator {
    ...
    const out = fs.openSync(`${this.analyzer_log_path}/analyzer_out.log`, 'a');
    const err = fs.openSync(`${this.analyzer_log_path}/analyzer_err.log`, 'a');
        ...
        var analyzer = child_process.spawn(
            ...
            ['./analyzer/main.py',
                ...
                "exclude_alerts=['INFTagDurationDoesntMatch','BitrateOutsideOfTargetAlert', 'InvalidKeyFrameIntervalAlert']"
            ],
            {
