...
function WowzaAdapter(mediaServerConfig,hostname) {
    ...
    this._wowzaDiagUrl = "http://" + authentication + hostname + ":8086/diagnostics/";
...
WowzaAdapter.prototype.getEntriesDiagnostics = function(suffix) {
    let entriesUrl = this._wowzaDiagUrl + suffix;
