...
module.exports = (function(){
    ...
    var populateFlavorData = function populateFlavorData(fdp, flavorData, flavorVideoData, flavorAudioData)
    {
        if (fdp.nginxInput_video)
        {
            ...
            flavorVideoData.offset = fdp.nginxInput_video.offset;
        ...
        if (fdp.nginxInput_audio)
        {
            ...
            flavorAudioData.offset = fdp.nginxInput_audio.offset;
    ...
    var generateInput = function (flavorDataProviders){
        return Q.fcall(function(){
            ...
            var firstValidFlavor = _.find(flavorDataProviders, function(fdp){
                return (fdp.nginxInput_audio || fdp.nginxInput_video);
            });

            resTemplate.durations.push(minTotalDuration);
            var firstValidStream = firstValidFlavor.nginxInput_video || firstValidFlavor.nginxInput_audio;
            resTemplate.firstClipTime = firstValidStream.firstClipTime;
