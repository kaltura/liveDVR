...
module.exports = (function(){
    ...
    var createEntryDownloader = function(e){
        ...
        return sessionManager.isNewSession(e.entryId)
            ...
            .then(function() {
                var entryDownloader = new entryDownloaderCtor(e.entryId, that.hostname, that.port, that.applicationName, e.flavorParamsIds.split(","), e.dvrWindow, e.maxChunkCount);
