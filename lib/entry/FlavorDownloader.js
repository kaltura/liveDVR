...
var FlavorDownloader = (function() {
    ...
    function diagnosticsPushData(mp4Data) {
        ...
        this.mediaInfo.actualFramerateArray.push(+(mp4Data.ts_info.video.duration / mp4Data.ts_info.video.frameCount).toFixed(decimalDigitsCount));
    ...
    function useSavedChunks(){
        ...
        if (this.recordingStartTime)
        {
            ...
            {
                let mp4FilesToUse = _.filter(mp4Files, (currMp4file)=>{return ((currMp4file.startTime + currMp4file.video.duration) > that.recordingStartTime)});
