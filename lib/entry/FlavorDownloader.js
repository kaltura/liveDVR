...
var FlavorDownloader = (function() {
    ...
    function getTotalBitrate(fallbackBitrate) {
        if (this.encoderInformation && this.encoderInformation.Encoder) {
            return this.encoderInformation.videoBitrate + this.encoderInformation.audioBitrate;
        }
        else {
    ...
    FlavorDownloader.prototype.setEncodedBitrate = function(encoderInformation) {
        ...
        let encoderBitrate = {
            ...
            videoBitrate : this.encoderInformation.Encoder.videoBitrate * 1024,
            audioBitrate : this.encoderInformation.Encoder.audioBitrate * 1024
        };
