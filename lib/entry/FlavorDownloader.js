...
var FlavorDownloader = (function() {
    ...
    function diagnosticsPushData(mp4Data) {
        ...
        this.mediaInfo.framesPerSecond = getEncoderFrameRate.call(this, mp4Data.metaData.framerate);
    ...
    function getEncoderFrameRate(fallbackFrameRate) {
        if (this.encoderInformation && this.encoderInformation.Encoder) {
            return this.encoderInformation.Encoder.frameRate ? this.encoderInformation.Encoder.frameRate : fallbackFrameRate;
        }
    }
