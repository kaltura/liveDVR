...
var FlavorDownloader = (function() {
    ...
    function diagnosticsPushData(mp4Data) {
        ...
        if (this.mediaInfo.framerateArray.length === numOfFrameRateSamples) {
            this.mediaInfo.framerateArray.shift();
        }
        this.mediaInfo.framerateArray.push(mp4Data.metaData.framerate);
    ...
    FlavorDownloader.prototype.getEncoderFrameRate = function() {
        ...
        return _.last(this.mediaInfo.framerateArray);
    };
