...
var FlavorDownloader = (function() {
    ...
    FlavorDownloader.prototype.setEncodedBitrate = function(encoderInformation) {
        ...
        this.setContentType(encoderBitrate);
        this.playlistGenerator.setEncoderBitrate(this.flavor, encoderBitrate);
    };

    FlavorDownloader.prototype.setContentType = function(encoderBitrate) {

        if (encoderBitrate.videoBitrate > 0 && encoderBitrate.audioBitrate > 0) {
            this.mediaInfo.contentType = FlavorContentType.videoAndAudio;
        } else if (encoderBitrate.videoBitrate > 0) {
            this.mediaInfo.contentType = FlavorContentType.video;
        } else if (encoderBitrate.audioBitrate > 0) {
            this.mediaInfo.contentType = FlavorContentType.audio;
        } else {
            this.logger.warn("flavor content type is unknown");
            this.mediaInfo.contentType = FlavorContentType.unknown;
        }
    };
