        ...
        return Q.fcall(function() {
            return downloadFlavorManifest()
                ...
                .then(function(result) {
                    ...
                    if (err instanceof httpUtils.HttpDownloadNotChanged) {
                        return Q.resolve();
                    } else {
                        if (err instanceof httpUtils.HttpRequestError) {

                            if (_.isFunction(that.flavorObj.refresh)) {
                                try {
                                    that.flavorObj.refresh();
                                }catch(e) {
