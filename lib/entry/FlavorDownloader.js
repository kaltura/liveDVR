...
var FlavorDownloader = (function() {
    ...
    function FlavorDownloader(flavorObj, entryObj, playlistGenerator, recordingEnable, successPollingIntervalMilliseconds, failurePollingIntervalMilliseconds) {
        var that = this;
        ...
        this.successPollingInterval = successPollingIntervalMilliseconds;
        this.failPollingInterval = failurePollingIntervalMilliseconds;
