...
var FlavorDownloader = (function() {
    ...
    function FlavorDownloader(flavorObj, entryObj, destPath, playlist) {
        var that = this;
        ...
        this.playlistGenerator = twoPhasedChunklistManifestGenerator(downloadedChunksGetter, this.destFolderPath, newPlaylistName, entryObj.dvrWindow, entryObj.maxChunkCount, this.logger);
                ...
                .then(function(playlistDestPath) {
                    return m3u8Handler.parseM3U8(playlistDestPath)
                        ...
                        .then(function(newChunks) {
                            ...
                            return Q.allSettled([downloadChunksPromise]);
                        })
    ...
    FlavorDownloader.prototype.start = function (onIterationEndCallback) {
        ...
        return qfs.makeTree(this.tmpM3u8Folder)
            .then(function() {
                return that.playlistGenerator.init();
            })
            .then(function(){
