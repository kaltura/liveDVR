                ...
                .then(function({fileFullPath, hash}) {
                    ...
                    return that.tsHttpUtils.downloadConvert(chunkUrl, path.join(fileFullPath, chunkName))
                        .then(function(mp4File) {
                            chunkName = persistenceFormat.normalizeChunkName(chunkName);
    ...
    function onDiagnosticsPushError(diagnosticsErrorObj) {
        ...
        switch (diagnosticsErrorObj.code) {
            ...
            case errorCode.mp4ConversionFailure:
                let msg = diagnosticsErrorObj.arguments.errorMsg + "; " + diagnosticsErrorObj.arguments.chunk;
                diagnosticsPushError.call(that, "MP4 Conversion Failure", diagnosticsErrorObj.time, msg);
        }
