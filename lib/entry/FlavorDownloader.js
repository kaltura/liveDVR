                    ...
                    return m3u8Handler.parseM3U8(result.content,{ verbatim: true})
                        ...
                        .then(function(results) {
                            ...
                            if (results.newMp4Files.length > 0) {
                                ...
                                if (that.recordingEnable && that.entryObj.recordingStatus ==  kalturaTypes.KalturaRecordingStatus.ACTIVE) { //if recording is enable, and flavor is source, send event
                                    try {
