...
var FlavorDownloader = (function() {
    ...
    function inspectMp4FileAlerts(mp4File) {
        ...
        if (Math.abs(keyFrameIntervalExpected - keyFrameInterval) > keyFrameIntervalDiffAllowed) {
            ...
            alertsToReport.push(new diagnosticsAlerts.InvalidKeyFrameInterval(mp4File.flavor, mp4File.chunkName, keyFrameIntervalExpected/1000, Math.round(keyFrameInterval)/1000));
        }
