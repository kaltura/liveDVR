...
var FlavorDownloader = (function() {
    ...
    function FlavorDownloader(flavorObj, entryObj, playlistGenerator, recordingEnable) {
        ...
        this.explicitLive = entryObj.explicitLive;
        this.recordingStatus = entryObj.recordingStatus;
                    ...
                    return m3u8Handler.parseM3U8(result.content,{ verbatim: true})
                        ...
                        .then(function(results) {
                            ...
                            if (results.newMp4Files.length > 0) {
                                ...
                                //@@NA replace recording status with enum from updated client.
                                if (that.recordingEnable && (!that.explicitLive || that.recordingStatus ==  2)) { //if recording is enable, and flavor is source, send event
                                    try {
