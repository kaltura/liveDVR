...
var FlavorDownloader = (function() {
    ...
    function FlavorDownloader(flavorObj, entryObj, destPath, newPlaylistName) {
        ...
        this.m3u8generator = twoPhasedChunklistManifestGenerator(downloadedChunksGetter, this.destFolderPath, newPlaylistName, entryObj.dvrWindow, entryObj.manifestMaxChunkCount, this.logger);
