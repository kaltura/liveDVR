...
var FlavorDownloader = (function() {
    ...
    function FlavorDownloader(flavorObj, entryObj, playlistGenerator) {
        ...
        this.playlistGenerator.on('diagnosticsInfo', diagnosticsPushData.bind(this));
        this.mediaInfo = {};
                    ...
                    return that.tsHttpUtils.downloadConvert(chunkUrl, path.join(fileFullPath, chunkName))
                        .then(function(mp4File) {
                            ...
                            if(mp4File.metaData) {
                                ...
                                diagnosticsPushData.call(that, that.flavor, mp4File, null);
                            }
                            return mp4File;
                        });
                })
    ...
    function diagnosticsPushData(flavor, mp4Data, driftInfo) {
        if (flavor === this.flavor) {
            ...
            if (driftInfo) {
                this.mediaInfo.drift = driftInfo;
            }
        }
    }
