...
function checkWowzaDiagForErrors() {
    let currRunTime = this.wowzaDiagnosticsObj.entryInfo.inputs[1].clientProperties.timeRunningSeconds;
    let lastRunTime = this.wowzaDiagnosticsObj.runningTime;
    ...
    this.wowzaDiagnosticsObj.runningTime = currRunTime;
}
...
LiveEntry.prototype.update = function(diagObj) {
    this.wowzaDiagnosticsObj.entryInfo = diagObj;
    this.FSM.update();
};
...
LiveEntry.prototype.toJSON = function () {
    var diag = {
                 'wowzaInformation' : this.wowzaDiagnosticsObj.entryInfo,
