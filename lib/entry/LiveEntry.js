...
var EntryDiagnosticsAnalyzer = require('./../Diagnostics/EntryDiagnosticsAnalyzer');
...
function LiveEntry(entryObject) {
    ...
    this.diagnosticsAnalyzer = new EntryDiagnosticsAnalyzer(this.entryId, this.diagnostics);
