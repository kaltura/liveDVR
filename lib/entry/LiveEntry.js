...
function LiveEntry(entryObject) {
    ...
    this.on('reportBeacon', this.diagnostics.reportBeacon.bind(this.diagnostics));
    ...
    this.playlistGenerator.on('diagnosticsBeacon', this.diagnostics.reportBeacon.bind(this.diagnostics));
...
LiveEntry.prototype.start = function() {
    ...
    this.emit('reportBeacon', new diagnosticsAlerts.EntryStarted(this.entryId));
...
LiveEntry.prototype.stop = function() {
    ...
    if (this.FSM.current !== 'suspending') {
        this.emit('reportBeacon', new diagnosticsAlerts.EntryStopped(this.entryId));
    }
