...
function checkAdapterDiagForErrors() {
    let currRunTime = this.adapterDiagnosticsObj.entryInfo.inputs[1].clientProperties.timeRunningSeconds;
    let lastRunTime = this.adapterDiagnosticsObj.runningTime;
    ...
    this.adapterDiagnosticsObj.runningTime = currRunTime;
}

LiveEntry.prototype.onAdapterDiagnostics = function(adapterDiagObj) {
    this.adapterDiagnosticsObj.entryInfo = adapterDiagObj[this.entryId];
};
...
LiveEntry.prototype.update = function() {
    this.FSM.update();
};
...
LiveEntry.prototype.toJSON = function() {
    var diag = {
                 'sourceInformation' : this.adapterDiagnosticsObj.entryInfo,
