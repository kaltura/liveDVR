...
function handleStreamHealth() {
    let entryInfo = {
        'source' : this.adapterDiagnosticsObj.toJSON(),
        'flavors' : this.flavorsDownloaders.toJSON(),
    ...
    if (diagnosticsObj) {
        try {
            ...
            let entryInfo = {
                ...
                'flavors' : JSON.stringify(this.flavorsDownloaders),
                'playlistGenerator' : JSON.stringify(this.playlistGenerator)
            };
            this.diagnostics.handleDiagnosticsReport(entryInfo);
