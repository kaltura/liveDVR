...
module.exports = function(entryObject, manifestGenerator, logger) {
    ...
    function onstop(event, from, to) {
        ...
        logger.info(stateMachineMessagePattern, event.toUpperCase(), from, to);
        return backendClient.unregisterEntryInDatabase(entryObject.entryId, entryObject.serverType, logger)
            .catch(function(err) {
