...
module.exports = function(liveEntry) {
    ...
    function updateStreamInfo(currentTime) {
        ...
        if (+timeDiff >= +streamInfoUpdateInterval) {
            // todo: important to decide whether to remove or leave call to getEntryServerNodeId, since it is called directly from liveEntry
            ...
            return getEntryServerNodeId()
                ...
                .catch(function (err) {
                    ...
                    // todo: check why is entryServerNodeId reset required here????
