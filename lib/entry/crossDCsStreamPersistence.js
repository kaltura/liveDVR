...
class CrossDCsStreamPersistence {
    ...
    constructor(prefix) {
        ...
        let persistenceFileName = config.get('persistenceFileName');
        let lastSlashPos = persistenceFileName.lastIndexOf('/');
        this._persistenceFileName =  `${persistenceFileName.substr(0, lastSlashPos+1)}${prefix}_${persistenceFileName.substr(lastSlashPos+1)}`;
    }
