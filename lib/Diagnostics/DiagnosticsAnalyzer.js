...
class EntryDiagnostics extends EventEmitter{
    ...
    _checkBackupStreamOnlyAlert(serverType, redundancy) {
        let alertObj = new diagnosticsAlerts.BackupOnlyStreamAlert(this._entryId);
    ...
    runFullDiagnosticsAnalysis(diagnosticsObj, entryObject) {
        try {
            ...
            this._checkBackupStreamOnlyAlert(entryObject.serverType, entryObject.isRedundancy);
