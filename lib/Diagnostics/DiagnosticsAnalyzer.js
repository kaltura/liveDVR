...
const frameRateFluctuationPercentAllowed = config.get('diagnostics').frameRateFluctuationPercentAllowed
    ...
    _checkInconsistentFrameRate(flavorsArray) {
        ...
        let inconsistentFlavor = _.find(flavorsArray, f => {
            ...
            let inconsistent = this._frameRateAvgMap.get(flavor) &&
                               (Math.abs(this._frameRateAvgMap.get(flavor) - lastFrameRateSample) > (lastFrameRateSample * frameRateFluctuationPercentAllowed));
