...
class EntryDiagnostics extends EventEmitter{
    ...
    _checkStreamTypeAlert(serverType, redundancy) {
        let alertObj = new diagnosticsAlerts.BackupOnlyStream(this._entryId);
    ...
    runFullDiagnosticsAnalysis(diagnosticsObj, entryObject) {
        try {
            ...
            this._checkStreamTypeAlert(entryObject.serverType, entryObject.isRedundancy);
