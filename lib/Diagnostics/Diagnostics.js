...
class Diagnostics extends EventEmitter {
    constructor(entryObject) {
        ...
        this._diagnosticsReportTimoeoutHandler = null;
    ...
    cleanup() {
        ...
        clearTimeout(this._diagnosticsReportTimoeoutHandler);
    ...
    _runDiagnosticsReport() {
        ...
        .finally(() => {
            this._diagnosticsReportTimoeoutHandler = setTimeout(this._runDiagnosticsReport.bind(this), this._reportIntervalTimeInMSec);
        });
