...
const highSeverityKeyFrameInterval = config.get('diagnostics').highSeverityKeyFrameInterval;
...
class InvalidKeyFrameIntervalAlert extends FlavorAlert {
    constructor(flavor, chunkName, expectedKeyFrameInterval, actualKeyFrameInterval) {
        ...
        this.severity = (actualKeyFrameInterval >= highSeverityKeyFrameInterval) ? AlertSeverity.warning : AlertSeverity.info;
    }
    get msg() {
...
class BackupOnlyStreamAlert extends EntryAlert {
    constructor(entryId) {
        super(entryId);
        this.severity = AlertSeverity.info;
    }
...
module.exports = {
    ...
    BackupOnlyStreamAlert : BackupOnlyStreamAlert
};