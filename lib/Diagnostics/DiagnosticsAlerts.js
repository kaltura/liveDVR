...
class PtsDrift extends EntryAlert {
    constructor(entryId, ptsInfo, input) {
        super(entryId, input);
        this.args.video = {
            drift : ptsInfo.videoAnalysis.drift,
            first : {
                refClock : ptsInfo.firstPts.ptsData[0][0],
                refPts : ptsInfo.firstPts.ptsData[0][1],
                lastPts : ptsInfo.firstPts.ptsData[0][2],
                absPts : ptsInfo.videoAnalysis.firstAbsPts
            },
            last : {
                refClock : ptsInfo.lastPts.ptsData[0][0],
                refPts : ptsInfo.lastPts.ptsData[0][1],
                lastPts : ptsInfo.lastPts.ptsData[0][2],
                absPts : ptsInfo.videoAnalysis.lastAbsPts
            }
        };
        this.args.audio = {
            drift : ptsInfo.audioAnalysis.drift,
            first : {
                refClock : ptsInfo.lastPts.ptsData[1][0],
                refPts : ptsInfo.lastPts.ptsData[1][1],
                lastPts : ptsInfo.lastPts.ptsData[1][2],
                absPts : ptsInfo.audioAnalysis.firstAbsPts
            },
            last : {
                refClock : ptsInfo.lastPts.ptsData[1][0],
                refPts : ptsInfo.lastPts.ptsData[1][1],
                lastPts : ptsInfo.lastPts.ptsData[1][2],
                absPts : ptsInfo.audioAnalysis.lastAbsPts
            }
        };
    }
    get msg() {
