...
class BackupOnlyStream extends EntryAlert {
    constructor(entryId) {
        super(entryId);
        this.severity = AlertSeverity.info;
    }
    ...
    get msg() {
        return super.msg + ` Stream [${this.entryId}_${this.input}] is sent only to BACKUP server`;
    }
}
...
module.exports = {
    ...
    BackupOnlyStream : BackupOnlyStream
};