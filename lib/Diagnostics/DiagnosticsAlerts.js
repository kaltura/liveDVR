...
const DiagnosticsErrorCodes = {
    ...
    "InvalidKeyFrameInterval" : 7,
    "InvalidTypeAlert" : 8,
    "MissingReferenceAlert" : 9,
    "ValueOutOfRangeAlert": 10,
    "TargetDurationExceededAlert" : 11,
    "PtsDiscontinuityAlert" : 12,
    "HighFpsRate" : 13,
...
class InvalidKeyFrameInterval extends FlavorAlert {
    constructor(flavor, chunkName, configuredKeyFrameInterval, actualKeyFrameInterval) {
        super(flavor, chunkName);
        this.args.configuredKeyFrameInterval = configuredKeyFrameInterval;
        this.args.actualKeyFrameInterval = actualKeyFrameInterval;
        this.severity = (actualKeyFrameInterval >= 10) ? AlertSeverity.warning : AlertSeverity.info;
        this.isTimed = true;
    }
    get msg() {
...
class HighFpsRate extends FlavorAlert {
...
module.exports = {
    ...
    InvalidKeyFrameInterval: InvalidKeyFrameInterval,
