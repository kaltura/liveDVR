...
const minRecommendedKeyFrameInterval = config.get('diagnostics').minRecommendedKeyFrameInterval;
...
const DiagnosticsErrorCodes = {
    ...
    // Reserved for alert thrown from wowza
    "AuthenticationAlert_InvalidToken" : 111,
    "AuthenticationAlert_IncorrectStream" : 112,
    "AuthenticationAlert_EntryNotFound" : 113,
    "AuthenticationAlert_NoLivePermission" : 114,
    "AuthenticationAlert_TooManyStreams" : 115,
    // *************************************
    "InconsistentFrameRateAlert" : 116,
    "FrameRateDoesNotMatchAlert" : 117
};
...
class InvalidKeyFrameIntervalAlert extends FlavorAlert {
    constructor(flavor, chunkName, expectedKeyFrameInterval, actualKeyFrameInterval) {
        ...
        this.severity = (actualKeyFrameInterval >= maxRecommendedKeyFrameInterval) ? AlertSeverity.warning :
            (actualKeyFrameInterval <= minRecommendedKeyFrameInterval) ? AlertSeverity.critical : AlertSeverity.info;
    }
    get msg() {
...
class InconsistentFrameRateAlert extends FlavorAlert {
    constructor(flavor, chunkName, medianFrameRate, lastFrameRate) {
        super(flavor, chunkName);
        this.args.meanFrameRate = medianFrameRate;
        this.args.lastFrameRate = lastFrameRate;
        this.severity = AlertSeverity.info;
    }
    get msg() {
        return super.msg + ` Flavor frame rate ${this.args.lastFrameRate} is more than one SD from median ${this.args.meanFrameRate}`;
    }
}

class FrameRateDoesNotMatchAlert extends FlavorAlert {
    constructor(flavor, chunkName, configuredFrameRate, actualFrameRate) {
        super(flavor, chunkName);
        this.args.configuredFrameRate = configuredFrameRate;
        this.args.actualFrameRate = actualFrameRate;
        this.severity = AlertSeverity.info;
    }
    get msg() {
        return super.msg + ` Flavor frame rate ${this.args.actualFrameRate} doesn't match the configured ${this.args.configuredFrameRate}`;
    }
}
...
module.exports = {
    ...
    InconsistentFrameRateAlert : InconsistentFrameRateAlert,
    FrameRateDoesNotMatchAlert : FrameRateDoesNotMatchAlert
};