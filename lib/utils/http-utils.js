...
class HttpDownloadNotChanged extends Error {
    constructor() {
        super();
    }
}
...
function request(requestData)
{
    ...
    httprequest(requestData, function (error, response, body) {
        ...
        d.reject(new HttpRequestError(msg, response.statusCode));
    });
    return d.promise;
}
...
var HttpDownloader = function(loggerInfo ,compareFn) {
    ...
    obj.downloadFile = function(url, pathDestination, timeout) {
        ...
        if (timeout) {
            ...
            req.timeout = config.get("requestTimeout");
        }
        ...
        return request(req)
            ...
            .then(function(data) {
                ...
                if (compareFn && compareFn(data)) {
                    ...
                    return Q.reject(new HttpDownloadNotChanged());
                }
            ...
            .catch(function(err){
                if (err instanceof  Error) {
                    err.message += "; Failed to download file. Url: " + url + " Destination: " + pathDestination + " Err: " + err + " stack: " + err.stack;
                }
