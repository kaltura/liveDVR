...
from ConcatinationTask import ConcatinationTask
...
ConcatinationRunnerTask = TaskRunner(ConcatinationTask, concat_processors_count, concat_task,
...
for p in ConcatinationRunnerTask:
    p.join()
