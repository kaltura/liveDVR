 ...
 */
const BackendClient = require('../../lib/BackendClient.js');
const ErrorUtils = require('../../lib/utils/error-utils');

console.log("Adding server node [" + process.argv[2] + "]");
return BackendClient.addServerNode(process.argv[2])
    .then((apiResult) => {
        ...
        console.log("ServerNode [" + process.argv[2] + "] was successfully added to server");
